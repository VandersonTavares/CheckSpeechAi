          ...
          <div className="flex items-center">
            ...
            <div className="hidden md:block">
              <div className="ml-10 flex items-baseline space-x-4">
                ...
                <a href="#solutions" className="text-gray-300 hover:text-white px-3 py-2 rounded-md text-sm font-medium">Soluções</a>
                <a href="#clients" className="text-gray-300 hover:text-white px-3 py-2 rounded-md text-sm font-medium">Clientes</a>
                <a href="#prices" className="text-gray-300 hover:text-white px-3 py-2 rounded-md text-sm font-medium">Preços</a>
